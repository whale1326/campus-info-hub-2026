    ...
    <div style={{ maxWidth: 640, margin: "0 auto" }}>
      ...
      <Card title="发布信息">
        ...
        >
          ...
          >
            <TextArea rows={6} placeholder="请详细描述物品特征、丢失/拾到地点、交易要求等..." />
          </Form.Item>
          ...
          <Form.Item name="contact" label="联系方式" tooltip="微信号 / 手机号，方便其他人联系你">
            <Input placeholder="如：微信 abc123 / 138xxxx0000" />
          </Form.Item>

          <Form.Item name="image_url" label="图片链接" tooltip="粘贴图片URL（可选）">
            <Input placeholder="https://example.com/image.jpg（选填）" />
          </Form.Item>
